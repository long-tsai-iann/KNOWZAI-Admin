  ...
  return (
    <AdminShell active="help">
      ...
      <Section title="災情貼文審核 / 物資分配站審核">
        ...
        <p>
          如果一則內容有被檢舉過，標題旁邊會出現一個黃色的
          <strong>「被檢舉 N 次・查看紀錄」</strong>按鈕，點下去可以看到每一筆
          檢舉的檢舉人、填寫的原因跟時間，方便判斷這些檢舉是不是合理、要不要
          真的隱藏或刪除。
        </p>
        <p>每一則內容右邊有這些按鈕：</p>
        <ul className="ml-5 list-disc space-y-1">
          ...
          <li>
            ...
            <span className="font-semibold text-orange-700">
              按下這個按鈕，等於系統認定「這則內容底下的檢舉都是錯的」
            </span>
            ，每一位（還沒被記過點的）檢舉人都會各被記一點，點數累積到 5 點
            就會被暫停帳號一段時間（詳見下方「使用者管理」）——所以只有在
            確定內容真的沒問題、檢舉是濫用/誤報時才按，不要單純因為「想先讓
            它重新顯示，之後再確認」就按下去。
          </li>
          <li>
            <strong>刪除</strong>：
            ...
            一般情況建議先用「隱藏」就好。刪除不會影響檢舉人的紀點（只有
            「恢復顯示」才會）。
          </li>
        </ul>
      </Section>
      ...
      <Section title="使用者管理">
        ...
        <ul className="ml-5 list-disc space-y-1">
          ...
          <li>
            ...
            取捨，停權主要是「擋住之後再登入」，不是「立刻斷線」。這種手動
            停權是<strong>永久的</strong>，狀態欄會顯示「永久停權」，要靠
            按「解除停權」才會恢復。
          </li>
          <li>
          ...
          <li>
            <strong>檢舉紀點</strong>：這一欄記錄的是「這個人檢舉過的內容，
            後來被管理員在審核頁按下『恢復顯示』」的次數——換句話說，就是
            他檢舉有誤/濫用檢舉的次數。每累積到 5 點，系統會<strong>自動</strong>
            暫停這個帳號一段時間（不需要管理員手動操作）：第一次暫停 3 天，
            之後每再累積滿 5 點，暫停天數就加倍（3 天 → 7 天 → 14 天…）。
            這種自動暫停是<strong>有到期日的</strong>，狀態欄會顯示
            「暫停至 YYYY-MM-DD」，過期後對方下次登入時系統會自動解除，
            不需要管理員手動按「解除停權」；如果想提前讓他恢復，也可以手動
            按「解除停權」。
          </li>
          <li>
